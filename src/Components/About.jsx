...
export default function About() {
    return (
        <>
            <div className="scroll-mt-24 lg:mx-50 md:mx-25 sm:mx-15 px-4 lg:w-fit md:w-fit sm:w-fit w-full tracking-tight text-justify" id="about">
                <h1 className="text-white/80 xl:text-8xl my-5 text-2xl sm:text-2xl md:text-4xl lg:text-6xl font-bold">About Me</h1>
                <div className="flex flex-col gap-10 hiddenElem">
