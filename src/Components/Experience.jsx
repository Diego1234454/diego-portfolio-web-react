export const Experience = () => {
    return (
        <>
            <div className="grid sm:grid-cols-1 md:flex-col lg:grid-cols-2 min-h-screen space-y-8 scroll-mt-24" id="experience">
                <div className="flex flex-col items-center justify-start min-w-full"> {/*justify-center*/}
                    <div className="flex flex-col items-center justify-center min-w-full max-w-4xl gap-12">
                        ...
                        <div className="flex flex-col justify-center gap-2  w-full rounded-sm py-4 px-6 hover:scale-110 transition-transform duration-300 overflow-auto bg-gray-500/45 max-w-xl md:max-w-xl lg:max-w-md xl:max-w-xl  xs:bg-blue-950">
                ...
                <div className="flex flex-col items-center justify-start min-w-full"> {/*justify-center*/}
                    <div className="flex flex-col items-center  min-w-full max-w-4xl gap-12 ">
                        <h1 className="text-blue-400 text-2xl font-semibold capitalized">Experience</h1>
                        <div className="flex flex-col justify-center gap-2  w-full rounded-sm py-4 px-6 hover:scale-110 transition-transform duration-300 overflow-auto bg-gray-500/45 max-w-xl md:max-w-xl lg:max-w-md xl:max-w-xl">
