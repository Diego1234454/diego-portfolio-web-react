import {ArrowUp, Facebook, Instagram, Linkedin, Mail, MapPin, MessageCircle, Phone, Twitter} from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="rounded-lg shadow-xs items-center  flex flex-col">
                        ...
                        <div className="flex space-x-4 justify-center">
                            ...
                            <a href="https://x.com/Diego36196752" title="My Twitter account" target="_blank"><Twitter className="text-white/60 hover:text-blue-300/80 transition-colors"/></a>
