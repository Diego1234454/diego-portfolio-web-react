...
export const Header = () => {
    ...
    return (
        <>
            <div className={`top-0 z-50 sticky flex flex-col min-w-screen resize transition-colors duration-300 ${scrolled ? "bg-black/95" : "bg-black/90"}`}>
                <div className="w-full justify-between px-2 sm:px-2 md:px-20 p-4 flex">
