...
export const Footer = () => {
    return (
        <>
            <footer className="py-12 px-4 bg-card relative border-border mt-12 pt-8 flex flex-wrap justify-center items-center">
                ...
                <a href="#hero" className="p-2 rounded-full text-white transition-colors absolute right-0">
